local grid = {
  {0,0,0,0, 08, 02, 22, 97, 38, 15, 00, 40, 00, 75, 04, 05, 07, 78, 52, 12, 50, 77, 91, 08,0,0,0,0},
  ...
  {0,0,0,0, 67, 26, 20, 68, 02, 62, 12, 20, 95, 63, 94, 39, 63, 08, 40, 91, 66, 49, 94, 21,0,0,0,0},
  {0,0,0,0, 24, 55, 58, 05, 66, 73, 99, 26, 97, 17, 78, 78, 96, 83, 14, 88, 34, 89, 63, 72,0,0,0,0},
  {0,0,0,0, 21, 36, 23, 09, 75, 00, 76, 44, 20, 45, 35, 14, 00, 61, 33, 97, 34, 31, 33, 95,0,0,0,0},
  {0,0,0,0, 78, 17, 53, 28, 22, 75, 31, 67, 15, 94, 03, 80, 04, 62, 16, 14, 09, 53, 56, 92,0,0,0,0},
  ...
  {0,0,0,0, 04, 52, 08, 83, 97, 35, 99, 16, 07, 97, 57, 32, 16, 26, 26, 79, 33, 27, 98, 66,0,0,0,0},
  {0,0,0,0, 88, 36, 68, 87, 57, 62, 20, 72, 03, 46, 33, 67, 46, 55, 12, 32, 63, 93, 53, 69,0,0,0,0},
  {0,0,0,0, 04, 42, 16, 73, 38, 25, 39, 11, 24, 94, 72, 18, 08, 46, 29, 32, 40, 62, 76, 36,0,0,0,0},
...
for ir=1, 20 do
  for ic=5, 25 do
    ...
    local horiz = grid[ir][ic]*grid[ir][ic+1]*grid[ir][ic+2]*grid[ir][ic+3]
    max = math.max(max,vert,horiz,diagl,diagr)
  end
end
print(max)
